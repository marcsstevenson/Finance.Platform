...
namespace Finance.Repository.EfCore.Migrations
{
    ...
    public partial class CustomerApplication : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.CustomerAppliationFinancials",
                c => new
                {
                    Id = c.Guid(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CustomerAppliationFinancials", "CustomerApplication_Id", "dbo.CustomerApplications");
            ...
            DropIndex("dbo.CustomerAppliationFinancials", new[] { "CustomerApplication_Id" });
            ...
            DropTable("dbo.CustomerAppliationFinancials");
